...
BEGIN
    CREATE TABLE dbo.SyncLog (
        ...
        -- Mailbox process counters (Phase 2)
        MailboxesInserted    INT NOT NULL
            CONSTRAINT DF_SyncLog_MailboxesInserted DEFAULT 0,
        MailboxesUpdated     INT NOT NULL
            CONSTRAINT DF_SyncLog_MailboxesUpdated DEFAULT 0,
        MailboxesSoftDeleted INT NOT NULL
            CONSTRAINT DF_SyncLog_MailboxesSoftDeleted DEFAULT 0,
        MailboxesProcessed   INT NOT NULL
            CONSTRAINT DF_SyncLog_MailboxesProcessed DEFAULT 0,

        -- Permission process counters (Phase 3)
        MfcGroupsProcessed         INT NOT NULL DEFAULT 0,
        MfcMembersProcessed        INT NOT NULL DEFAULT 0,
        FullAccessProcessed        INT NOT NULL DEFAULT 0,
        SendAsProcessed            INT NOT NULL DEFAULT 0,
        SendOnBehalfProcessed      INT NOT NULL DEFAULT 0,
        FolderPermissionsProcessed INT NOT NULL DEFAULT 0,
        MailboxesSkipped           INT NOT NULL DEFAULT 0,

        -- Delta new-mailbox mini-baseline count (Phase 3 delta)
        NewMailboxesBaselined      INT NOT NULL DEFAULT 0
    );
