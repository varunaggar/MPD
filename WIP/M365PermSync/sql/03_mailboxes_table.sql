...
-- SyncLog mailbox columns are in 01_shared_tables.sql
...
BEGIN
    CREATE TABLE dbo.Mailboxes (
        ...
        -- When permissions were first collected for this mailbox.
        -- NULL = not yet collected. Set per-mailbox by Invoke-PermissionBaselineLoad
        -- and checked by Invoke-PermissionDeltaSync Phase 0.
        PermissionsBaselinedAt      DATETIME2           NULL,
